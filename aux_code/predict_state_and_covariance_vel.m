...
function [ X_km1_k, P_km1_k ] = predict_state_and_covariance_vel( X_k, P_k, type, SD_A_component_filter, SD_alpha_component_filter )
...
% delta_t = 0.1205;
global step_global
delta_t = (time_stamp(1,step_global)-time_stamp(1,step_global-1))*0.001;
...
% camera motion prediction
Xv_km1_k = fv_vel( X_k(1:13,:), delta_t, type, SD_A_component_filter, SD_alpha_component_filter  );
